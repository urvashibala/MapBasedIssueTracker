...
export type GetIssueUpvoteAggregateType<T extends IssueUpvoteAggregateArgs> = {
    [P in keyof T & keyof AggregateIssueUpvote]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateIssueUpvote[P]> : Prisma.GetScalarType<T[P], AggregateIssueUpvote[P]>;
};
...
type GetIssueUpvoteGroupByPayload<T extends IssueUpvoteGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<IssueUpvoteGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof IssueUpvoteGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], IssueUpvoteGroupByOutputType[P]> : Prisma.GetScalarType<T[P], IssueUpvoteGroupByOutputType[P]>;
}>>;
...
export type IssueUpvoteCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<IssueUpvoteFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface IssueUpvoteDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    [K: symbol]: {
        types: Prisma.TypeMap<ExtArgs>['model']['IssueUpvote'];
        meta: {
            name: 'IssueUpvote';
        };
    };
     ...
     * })
    **/
    count<T extends IssueUpvoteCountArgs>(args?: Prisma.Subset<T, IssueUpvoteCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], IssueUpvoteCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends IssueUpvoteGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, IssueUpvoteGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetIssueUpvoteGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export {};
//# sourceMappingURL=IssueUpvote.d.ts.map